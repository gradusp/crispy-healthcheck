...
import (
	...
	"github.com/gradusp/crispy-healthcheck/internal/app"
	"github.com/gradusp/crispy-healthcheck/internal/config"
...
func main() {
	...
	err := config.InitGlobalConfig(
		config.WithAcceptEnvironment{EnvPrefix: "HEALTHCHECK"},
		...
		config.WithDefValue{Key: app.ServerEndpoint, Val: "tcp://127.0.0.1:9000"},
	)
	if err != nil {
