...
func RegisterHealthCheckerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthCheckerServer) error {
	...
	mux.Handle("POST", pattern_HealthChecker_HttpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/HttpCheck", runtime.WithHTTPPathPattern("/v2/HttpCheck"))
		if err != nil {
	...
	mux.Handle("POST", pattern_HealthChecker_IcmpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/IcmpCheck", runtime.WithHTTPPathPattern("/v2/IcmpCheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HealthChecker_TcpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/TcpCheck", runtime.WithHTTPPathPattern("/v2/TcpCheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterHealthCheckerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthCheckerClient) error {
	...
	mux.Handle("POST", pattern_HealthChecker_HttpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/HttpCheck", runtime.WithHTTPPathPattern("/v2/HttpCheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HealthChecker_IcmpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/IcmpCheck", runtime.WithHTTPPathPattern("/v2/IcmpCheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HealthChecker_TcpCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.healthcheck.HealthChecker/TcpCheck", runtime.WithHTTPPathPattern("/v2/TcpCheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
